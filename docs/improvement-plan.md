...
- **Project detail desktop** (`/projects/:id`, Figma `project-detail-desktop` `4:678`) implemented with typed `Project.detail` for all projects. Pending: tablet/mobile project-detail frames; broader a11y/SEO polish and localizing remote assets.
