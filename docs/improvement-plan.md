...
- UI styles are design tokens + Sass + Geist fonts; **Bootstrap is fully removed** (no CSS/JS dependency).
...
1. Baseline + stack modernization — **done** (Angular 22 / Node 24; Bootstrap removed)
